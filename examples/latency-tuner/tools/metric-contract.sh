...
#                    your metric scores worse, you do not have a metric — you have an
#                    opinion, and the loop will optimize it into theater.
#
...
#   METRIC_DIRECTION  — 'higher' or 'lower': which direction is better
#
