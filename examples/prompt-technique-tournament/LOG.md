...
**Evaluator verdict:** Champion is `few_shot` at dev 55% / holdout 55%. Next untried technique: `keyword_rules`, a surface-token heuristic that sets `wants_refund=true` on "reopened" / "repeated ticket" patterns.
