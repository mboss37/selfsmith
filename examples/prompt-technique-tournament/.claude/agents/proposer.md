...
1. Read `METHODOLOGY.md` to understand the principles that govern valid technique proposals (generalization requirements, noise floor, combo redundancy rules).
2. Read `LOG.md` to understand what has already been tried and what failed. Do not re-propose a technique or combo already in `eval/leaderboard.md`.
...
- **Hypothesis**: one sentence stating which cases are failing and why.
