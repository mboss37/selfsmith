...
2. Read `eval/techniques.py` — understand the full catalog of available techniques and combos.
3. Read `GOAL.md` — understand what "good" looks like and which metrics matter most.
