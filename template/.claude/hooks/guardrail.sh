...
# Floor 1 — DOMAIN SAFETY. Replace {{DOMAIN_FORBIDDEN_PATTERN}} with your domain's "never do this"
# (e.g. mutating a sacred holdout, enabling real spend, touching production). Delete this block
# only if your domain has no such floor.
