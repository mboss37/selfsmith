#!/usr/bin/env bash
# run-iteration.sh: a single-flight, time-boxed, fresh-session wrapper for unattended runs.
#
...
#
# This wrapper does NOT sandbox. The guardrail deny-list is a tripwire, not a security boundary (shell
